                ...
                <nav className="text-nowrap py-3 md:py-6 px-4 flex items-center gap-4 justify-between md:mb-3">
                    ...
                    <div className="header-search-box flex gap-4 w-full flex-1">
                        <div className="hidden md:block">
                            <Button className="gap-4 bg-slate-50 py-[5px] px-4 leading-5" style={{border: '1px solid #e0e0e0'}}>
                                <div className="text-left">
                                    <span className="name block text-gray-500 text-xs">Your Location</span>
                        ...
                        <div className="hidden md:flex gap-3 items-center flex-1">
                            ...
                            <div className="relative flex-1">
                                <input className="px-3 py-3 border-2 border-slate-300 bg-slate-200 outline-none text-sm rounded w-full" />
                    ...
                    <div className="header-cta flex gap-3">
                        <Button className="rounded-full bg-red-50 min-w-0 p-2 hover:bg-purple-200 md:hidden" style={{border: '1px solid #cbcbcb'}}><IoSearch className="text-2xl text-purple-800"/></Button>
                        <Button className="rounded-full bg-red-50 min-w-0 p-2 hover:bg-purple-200" style={{border: '1px solid #cbcbcb'}}><IoBagHandleOutline className="text-2xl text-purple-800"/></Button>
                ...
                <div className="flex justify-between items-start gap-5 px-3">
                    ...
                    <ul className="flex gap-0 md:gap-3 items-center md:flex-wrap text-nowrap bg-white overflow-auto md:overflow-visible border-b-4 border-gray-200 md:border-0">
                        <li className="relative group">
                            <Button className="bg-white text-sm text-gray-700 rounded-full py-2 md:px-4">Home</Button>
                        </li>
                        {categories.categoryList.map(i => (
