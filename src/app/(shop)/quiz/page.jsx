    ...
    return (
        <main className='quiz-home'>
            ...
            <div className="container mx-auto">
                {addForm ?                 
                    <div className="p-6">
                        <h2 className="text-xl font-semibold border-b border-gray-300 pb-4 flex items-center">Create a Quiz <IoArrowBack className='ml-auto text-[1.7rem] text-purple-700' onClick={() => setAddForm(false)} /></h2>
                        <form className="mt-6">
                    ...
                    :
                    <div className="p-6">
                        <h2 className="text-xl font-semibold border-b border-gray-300 pb-4">Your Quiz List</h2>
                        <div className="mt-6">
                            <div >
                                <ul className="mb-4">
                                    {quizList.map(i => (
                                        <li className="mb-4" key={i.id}>
                                            <Link prefetch={false} href={`/quiz/${i.id}`}>
