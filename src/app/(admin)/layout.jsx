        ...
        <>
            <section>
                <main className=''>
                    <div style={{paddingLeft: active ? '0' : '75px'}} className="transition duration-300">
                        <nav className="flex gap-5 items-center justify-between p-4 border border-gray-300 mb-4">
                            <div className="flex gap-5 items-center flex-1 max-w-[45rem]">
                                <RiMenu2Fill onClick={() => setActive(!active)} className="text-3xl text-blue-600" />
                    ...
                    <div style={{transform: active ? 'translateX(-75px)' : 'translateX(0)'}} className='sidebar overflow-auto transition duration-300 p-4 border-r border-gray-300 fixed top-0 bottom-0 left-0 z-[1111] bg-white'>
                                                                                                                    {/* min-w-72 */}
                        <div>
