          ...
          <div className="col-span-5">
            ...
            <div className="mt-4">
              <div className="flex justify-between items-end">
                ...
                <Button className="text-purple-800 bg-white text-nowrap border-[3px] border-purple-800 rounded-lg py-2 px-7 hover:border-[3px] hover:text-white hover:bg-purple-800" variant="outlined">View All</Button>
              </div>
              <div className="grid gap-3 mt-4 product-grid">
                {featuredProducts.reverse().map(i => (<ProductCard key={i.id} data={i} classes='max-w-none' />))}
              </div>
              <div className="grid grid-cols-2 gap-3 p-7 mt-4 overflow-hidden rounded" style={{background: '#F8EFEA'}}>
                <div>
