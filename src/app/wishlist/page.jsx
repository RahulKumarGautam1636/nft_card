                                    ...
                                    <tr>
                                        <td colSpan={6}>
                                            <div className="flex justify-between gap-4 items-center">
                                                ...
                                                <Button onClick={() => dispatch(dumpWishlist())} className="bg-purple-800 text-white whitespace-nowrap rounded-lg py-[0.86rem] px-7 hover:bg-purple-500">Remove All</Button>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
