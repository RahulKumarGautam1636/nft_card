...
//                 <div>
//                   <a href="#" className="text-white bg-gradient-to-br from-pink-500 to-violet-500 font-medium rounded-lg shadow-md shadow-gray-300 hover:scale-[1.02] transition-transform inline-flex justify-center items-center text-sm px-5 py-2.5 text-center w-full sm:w-auto">
...
//                   </div>
//                 </div>
//                 <button className="text-white bg-gradient-to-br from-pink-500 to-violet-500 font-medium rounded-lg shadow-md shadow-gray-300 hover:scale-[1.02] transition-transform text-sm px-5 py-2.5 text-center" type="submit">
//                   Update
//                 </button>
//               </form>
//             </div>
